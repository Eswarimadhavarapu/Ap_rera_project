  ...
  return (
    <div className="report-page-wrapper">
      ...
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/home" className="text-white underline" target="_blank" rel="noopener noreferrer">Home</Link> / <Link to="/mis-reports" className="text-white underline" target="_blank" rel="noopener noreferrer">MIS Reports</Link> / R9.3 Report
      </div>
