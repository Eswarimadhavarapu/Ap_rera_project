...
//     alert("Form data captured (API removed)");
//   };
...
//               <select name="bankState" onChange={handleChange}>
...
//               <input name="branchName" onChange={handleChange} />
//             </div>
...
//               <input name="accountHolder" onChange={handleChange} />
//             </div>
...
//       <label>
//         <input type="radio" name="otherStateReg" value="yes" /> Yes
//       </label>
//       <label>
//         <input type="radio" name="otherStateReg" value="no" /> No
//       </label>
//     </div>
//   </div>
// </div>
  ...
  const fetchExistingProject = async () => {
    try {
      ...
      setFormData(prev => ({
        ...
        mobile: data.mobile,
        email: data.email,
        stateUT: data.state_ut,
        district: data.district,

        otherStateReg: data.other_state_reg,
        lastFiveYears: data.last_five_years,
...
const handleSaveAndContinue = () => {
  ...
  alert("Form saved locally. Moving to Project Details");
