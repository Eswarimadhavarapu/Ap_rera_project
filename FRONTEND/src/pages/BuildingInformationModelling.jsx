...
export default function BuildingInformationModelling() {
  return (
    <section className="learning-page">
      {/* ✅ Breadcrumb */}
      <div className="buildingform-learning-page">
        <span className="buildingform-bread-text">You are here :</span>
        <Link className="bread-link" to="/">Home</Link>
        <span className="bread-slash">/</span>
        <span className="bread-current">Building Information Modelling</span>
      </div>

      <div className="page-container">
        <h1 className="page-title">Building Information Modelling</h1>
        ...
        <h2 className="page-subtitle">CHALLENGES OF INDIAN REAL ESTATE SECTOR</h2>
        ...
        <h2 className="page-subtitle">INFLUENCE OF TECHNOLOGY IN REAL ESTATE SECTOR</h2>
        ...
        <h1 className="page-bigtitle">How BIM modeling benefits to real estate sector</h1>
        <div className="page-line"></div>

        <h2 className="page-subtitle">BETTER OUTPUT THROUGH BIM COLLABORATION</h2>
        <p className="page-para">
        ...
        <h2 className="page-subtitle">OPTIMIZED PERFORMANCE</h2>
        <p className="page-para">
        ...
        <h1 className="page-bigtitle">Vendors in Building Information Modeling Software</h1>
        <div className="page-line"></div>

        <div className="vendor-grid">
          <div className="vendor-col">
            <h3 className="vendor-title">Architecture</h3>
            ...
            <h3 className="vendor-title">Sustainability</h3>
            <ul className="vendor-list">
          ...
          <div className="vendor-col">
            <h3 className="vendor-title">Structures</h3>
            <ul className="vendor-list">
            ...
            <h3 className="vendor-title">MEP</h3>
            <ul className="vendor-list">
        ...
        <div className="vendor-grid" style={{ marginTop: "40px" }}>
          <div className="vendor-col">
          ...
          <div className="vendor-col">
            <h3 className="vendor-title">Facility Managment</h3>
            <ul className="vendor-list">
