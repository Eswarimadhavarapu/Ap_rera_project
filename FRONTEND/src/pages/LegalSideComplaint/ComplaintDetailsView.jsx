...
const DOC_BASE_URL = "https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/document/";
...
const RejectModal = ({ data, onClose, onSuccess }) => {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      await fetch("https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/send-rejection-mail", {
        method: "POST",
...
const ApproveModal = ({
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      await fetch("https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/approve-mail", {
        method: "POST",
        body: fd,
      });
      setData((prev) => ({
...
const [venue, setVenue] = useState("");
  ...
  const sendNotice = async () => {
    ...
    try {
      ...
      await fetch(
        "https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/send-notice",
        {
          method: "POST",
...
respondentDocs.forEach((file) => {
  fd.append(
    ...
    file
      ...
      await fetch("https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/add-hearing", {
        method: "POST",
        body: fd,
      });
...
console.log("TYPE 👉", complaintType);
 ...
 const fetchComplaint = () => {
  fetch(`https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/${id}`)
    .then((r) => r.json())
    .then((res) => {
          ...
          <div className="AdminComplaintDetail-modal">
            ...
            <div className="AdminComplaintDetail-modal-footer">
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    await fetch(`https://n7vxv3pg-8081.inc1.devtunnels.ms/api/complint/${complaint?.complaint_id}/reopen`, { method: "POST" });
