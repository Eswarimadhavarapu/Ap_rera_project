...
const panNumber =
  location.state?.panNumber || sessionStorage.getItem("panNumber")||"SUNIL6565H";

const applicationNumber =
  location.state?.applicationNumber || sessionStorage.getItem("applicationNumber")||"5555555566";
