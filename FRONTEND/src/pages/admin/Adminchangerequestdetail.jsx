          ...
          <div className="acr-detail-card">
            ...
            <div className="acr-detail-grid">
              {[
                ...
                { label: "Payment Status",      value: request.payment_status,
                  badge: true,
                ...
                {Object.entries(subsections).map(([subKey, rows]) => (
                  <div key={subKey} className="acr-subsection-group">
                    ...
                    <div className="acr-subsection-label">
                      ...
                      <span className="acr-change-count">{rows.length} change{rows.length !== 1 ? "s" : ""}</span>
                    </div>
                          ...
                          <tr key={c.id}>
                            ...
                            <td>
                              <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                                {c.old_file_path && (
                                  <a
                                    href={`${BASE_URL}/${c.old_file_path}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="acr-doc-link old"
                                  >
                                    📄 Old File
                                  </a>
                                )}
                                {c.new_file_path && (
                                  <a
                                    href={`${BASE_URL}/${c.new_file_path}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="acr-doc-link new"
                                  >
                                    📄 New File
                                  </a>
                                )}
                                {c.proof_document_name && (
                                  <a
                                    href={`${BASE_URL}/${c.proof_document_name}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="acr-doc-link proof"
                                  >
                                    📎 Proof
                                  </a>
                                )}
                    ...
                    {/* data_json block (if present) */}
                    {rows.some((r) => r.data_json) && (
                      <div className="acr-json-block">
                        <div className="acr-json-title">Additional Data (JSON)</div>
                        {rows.filter((r) => r.data_json).map((r) => (
                          <pre key={r.id} className="acr-json-pre">
