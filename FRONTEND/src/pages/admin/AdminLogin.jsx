...
//       localStorage.setItem("admin_login_event", Date.now()); // ✅ add this
...
// import { useNavigate } from "react-router-dom";
// import "../../styles/admin/adminLogin.css";
// import TopHeader from "../../components/admin/TopHeader.jsx";
...
const DepartmentLogin = () => {
  ...
  const navigate = useNavigate();
  const { clearAdmin, saveAdmin } = useAdmin();
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      if (!isPlatformAdmin(data.admin) && nextRoute === "/department") {
        setError("Your department is not mapped to a dashboard yet.");
        clearAdmin();
        setStep("login");
        setOtp("");
        return;
