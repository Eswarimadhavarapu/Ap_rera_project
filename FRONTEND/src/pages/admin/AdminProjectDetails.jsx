...
const [approveRemark, setApproveRemark] = useState("");
  ...
  useEffect(() => {
    fetch(`https://n7vxv3pg-8081.inc1.devtunnels.ms/api/admin/projects/${id}`)
      .then(res => res.json())
...
>
  ...
  try {
    const response = await fetch(`https://n7vxv3pg-8081.inc1.devtunnels.ms/api/admin/projects/${id}/reject`, {
      method: "PUT",
      headers: {
    ...
    <div className="admin-project-details__modal">
      ...
      <div className="admin-project-details__modal-footer">
        ...
        <button
          ...
          onClick={async () => {
  try {
    const response = await fetch(`https://n7vxv3pg-8081.inc1.devtunnels.ms/api/admin/projects/${id}/approve`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json"
      },
