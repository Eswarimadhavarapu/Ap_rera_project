// OtherThanIndividualProjectPreview.jsx
import React, { useState, useEffect } from "react";
import { useNavigate, useLocation } from "react-router-dom";
import ProjectWizard from "../components/ProjectWizard";
import "../styles/ProjectPreview.css";
import "../styles/aprera-print-override.css";
import { apiPost, apiGet, BASE_URL } from "../api/api";
...
const OtherThanIndividual_ProjectPreview = () => {
...
<section className="section">
  <h2 className="section-title">Authorized Signatory Details</h2>
  ...
  <table className="data-table">
    <tbody>
      <tr>
        ...
        <td className="value-cell">
          {project["Authorized Signatory Name"] || "N/A"}
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="value-cell">
          {project["Authorized Signatory Mobile"] || "N/A"}
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="value-cell">
          {project["Authorized Signatory Email"] || "N/A"}
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="value-cell">
          {project["Is Existing Director"] || "N/A"}
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="value-cell">
          {project["Authorized Signatory Photo"] ? (
            <a
              href={project["Authorized Signatory Photo"]}
              target="_blank"
              rel="noreferrer"
            >
              View Photo
      ...
      <tr>
        ...
        <td className="value-cell">
          {project["Board Resolution Copy"] ? (
            <a
              href={project["Board Resolution Copy"]}
              target="_blank"
              rel="noreferrer"
            >
              View Document
...
export default OtherThanIndividual_ProjectPreview;