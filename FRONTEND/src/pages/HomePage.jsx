...
function OfficeAddress() {
  return (
    <section className="visit-office-section">
      ...
      <div className="visit-office-header">
        <h2>VISIT OUR OFFICE</h2>
        <div className="visit-office-line"></div>

        <p>
          Visit us for meetings, support, and in-person assistance.
        </p>
      </div>
      ...
      <div className="visit-office-wrapper">
        ...
        <div className="visit-office-card">
          ...
          <div className="visit-office-icon-wrap">
            <FaMapMarkerAlt className="visit-office-main-icon" />
          </div>

          <h3>Headquarters</h3>

          <p className="visit-office-address">
            APCRDA Project Office,
            <br />
            Off, Seed Access Rd, Kondarajupalem,
            <br />
            Amaravati, Andhra Pradesh – 522237.
          </p>

          <div className="visit-office-contact">
            <p>
              <FaPhone />
              6304906011 (Mon–Sat, 10AM–6PM)
            </p>

            <p>
              <FaEnvelope />
              helpdesk-rera@ap.gov.in
            </p>
          </div>

          <a
            href="https://www.google.com/maps/search/?api=1&query=APCRDA+Project+Office+Amaravati"
            target="_blank"
            rel="noopener noreferrer"
        ...
        {/* RIGHT MAP */}
        <div className="visit-office-map">

          <iframe
            title="AP RERA Office Map"
            src="https://www.google.com/maps?q=APCRDA+Project+Office+Amaravati&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
...
export default function HomePage() {
  return (
    <>
      ...
      <Services />        {/* Registration */}
      <Publicnotice />
      <OfficeAddress />   {/* Our Philosophy cards */}
      <Statics />        {/* 👈 NEW Dashboard stats */}
      {/* <Philosophy /> */}
      {/* <Dashboard /> */}
      <Expertise />
